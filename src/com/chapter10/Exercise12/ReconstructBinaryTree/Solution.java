package com.chapter10.Exercise12.ReconstructBinaryTree;

import com.chapter10.BinaryTreeNode;
import com.chapter10.InitializeBinaryTree;
...
public class Solution {
    ...
    private static BinaryTreeNode<String> binaryTreeFromPreorderInorderHelper(
        ...
        var result = new BinaryTreeNode<>(preOrder.get(preOrderStart));
        // go to the left
        result.left = binaryTreeFromPreorderInorderHelper(preOrder, preOrderStart + 1,
                preOrderStart + 1 + leftSubTreeSize,
                inOrderStart, rootInorderIndex, nodeToInOrderIndex);
        // go to the right
        result.right = binaryTreeFromPreorderInorderHelper(preOrder, preOrderStart + 1 + leftSubTreeSize,
